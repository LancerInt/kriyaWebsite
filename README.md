...
- Responsive hero artwork is delivered via `<picture>` with desktop/tablet/mobile sources; see `images-notes.md` for exact dimensions and filenames when swapping in final photography.
